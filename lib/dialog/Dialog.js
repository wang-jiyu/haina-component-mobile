...
var Dialog = /** @class */ (function (_super) {
    ...
    function Dialog() {
        ...
        _this.getDialogElement = function () {
            ...
            var dialogElement = (React.createElement(LazyRenderBox_1.default, { key: "dialog-element", role: "document", ref: function (el) { return _this.dialogRef = el; }, style: props.style || {}, className: prefixCls + " " + (props.className || ''), visible: props.visible },
