...
export default class RefreshControl extends React.Component<IRefreshProps, any>{
    ...
    static endDownLoading(isSuccess: boolean = true, successTips?: string) {
    ...
    static endUpLoading(isFinishUp: boolean = false) {
    ...
    //在特定的时间内，滚动到指定的y位置
    static scrollTo(y: number, duration: number) {
    ...
    //	新的配置参数，有一些属性无法更改
    static refreshOptions(options: IRefreshProps) {
    ...
    render() {
        ...
        return (
            <div id="haina-refresh" className="minirefresh-wrap">
